...
// ============ WORKING CORS HANDLER ============
app.use((req, res, next) => {
    // ALWAYS set these headers for ALL requests
    res.header('Access-Control-Allow-Origin', 'https://innovationneumologia.github.io');
    res.header('Access-Control-Allow-Credentials', 'true');
    res.header('Access-Control-Allow-Methods', 'GET, POST, PUT, DELETE, OPTIONS');
    res.header('Access-Control-Allow-Headers', 'Content-Type, Authorization, X-Requested-With');
    
    // Handle OPTIONS pre-flight IMMEDIATELY
    if (req.method === 'OPTIONS') {
        console.log('OPTIONS pre-flight request received');
